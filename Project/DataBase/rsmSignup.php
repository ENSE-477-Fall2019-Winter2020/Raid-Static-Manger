...
$validation = "Error Check will be display at here..";
...
if (isset($_POST["submit"])) {
    ...
    if ($email == "" || ! filter_var($email, FILTER_VALIDATE_EMAIL)) {
        $validate = false;
        $validation = "";
        $error0 = "Email is empty or invalid";
    } else {
        $error0 = "";
    }
									...
									<div class="card">
										<div class="card-block">
											...
											<div class="card-body">
												...
												<div class="mt-3">
													Before Login to the Manager, Please Sign up to get your
													account<br />
													...
													<div class="col-12">
														<div class="forgetpass mt-3">
															...
															<table>
																...
																<tr>
																	<td class="err_msg"><?php echo "$error0";?></td>
																</tr>
																<tr>
